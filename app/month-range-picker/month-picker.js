...
$(function() {
    ...
    content += '<div style="margin-left: 10px">This month-range picker here is only for demo. In prototype it does not influence chart.</div>';
    content += '<div style="margin-left: 10px">In real App it will influence totals aggregation span and histograms.</div>';
